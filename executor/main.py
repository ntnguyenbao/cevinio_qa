...
def main():
    ...
    parser.add_argument("--headless", required=False, default=False, action='store_true', help=f'Execute testing in headless/silent mode')
    ...
    args['variable'].append('headless:%s' % args['headless'])
    args.pop('browser')
    args.pop('headless')
